...
- (id)initWithVideo:(NSString *)moviePath usesTcp:(BOOL)usesTcp modeVideo:(int)mode __attribute__((deprecated))
{
...
- (void)setupAudioDecoder
{
    if (audioStream >= 0) {
        ...
        codec = avcodec_find_decoder(_audioCodecContext->codec_id);
